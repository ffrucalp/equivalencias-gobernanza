...
const TablaProvisional = lazy(() => import("./pages/TablaProvisional"));
const ReporteAlumno = lazy(() => import("./pages/ReporteAlumno"));
...
const PageFallback = () => (
  <div style={{ padding: 40, textAlign: "center", color: C.textSecondary }}>
    <div style={{ fontSize: 24, marginBottom: 8 }}>⚙️</div>Cargando...
  </div>
);
